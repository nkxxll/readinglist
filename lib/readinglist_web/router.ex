defmodule ReadinglistWeb.Router do
  ...
  import ReadinglistWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ReadinglistWeb.Layouts, :root}
  ...
  if Application.compile_env(:readinglist, :dev_routes) do
  ...
  scope "/", ReadinglistWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ReadinglistWeb.UserAuth, :require_authenticated}] do
      live "/users/settings", UserLive.Settings, :edit
      live "/users/settings/confirm-email/:token", UserLive.Settings, :confirm_email
      live "/readinglist-live", ReadinglistLive.Index, :index
    end
  ...
  scope "/", ReadinglistWeb do
    ...
    live_session :current_user,
      on_mount: [{ReadinglistWeb.UserAuth, :mount_current_scope}] do
